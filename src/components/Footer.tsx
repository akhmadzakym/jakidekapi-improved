    ...
    <footer className="bg-ctp-crust text-ctp-subtext1 py-5 md:px-20 max-sm:px-3 md:mt-17 max-sm:mt-41 border-t-2 font-display">
      ...
      <div className="flex flex-row px-5 my-5 items-center justify-between">
        <ul className="grid gap-2 text-sm">
            ...
            <li className="underline"><a href="https://tumblr.com/blog/jakidekapi/">Tumblr</a></li> 
            <li className="underline"><a href="https://www.instagram.com/jakidekapi/">Instagram</a></li>
            <li className="underline"><a href="https://bsky.app/profile/jakidekapi.fun/">Bluesky</a></li>
        ...
        <svg className="md:mt-20 md:mb-10 max-sm:mt-10 px-5 fill-ctp-text" viewBox="0 0 675.42 174.31">
