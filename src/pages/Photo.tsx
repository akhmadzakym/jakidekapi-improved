...
const Photo = () => {
    ...
    return (
        <div className="max-sm:ml-5 max-sm:mr-5
            ...
            <img className="rounded-2xl" src="/photos/photograp/IMG_4153.gif"></img>
            ...
            <img className="rounded-2xl" src="/photos/photograp/1.gif"></img>
            <img className="rounded-2xl" src="/photos/photograp/2.gif"></img>
            <img className="rounded-2xl" src="/photos/photograp/3.gif"></img>
            <img className="rounded-2xl" src="/photos/photograp/4.gif"></img>
            <img className="rounded-2xl" src="/photos/photograp/5.gif"></img>
            <img className="rounded-2xl" src="/photos/photograp/6.gif"></img>
            <img className="rounded-2xl" src="/photos/photograp/7.gif"></img>
            <img className="rounded-2xl" src="/photos/photograp/8.gif"></img>
            <img className="rounded-2xl" src="/photos/photograp/9.gif"></img>
            <img className="rounded-2xl" src="/photos/photograp/10.gif"></img>
            <img className="rounded-2xl" src="/photos/photograp/11.gif"></img>
            <img className="rounded-2xl" src="/photos/photograp/12.gif"></img>
            <img className="rounded-2xl" src="/photos/photograp/13.gif"></img>
        </div>
