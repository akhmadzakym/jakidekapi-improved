  ...
  return (
    ...
    <div className="font-display">
      ...
      <div className="xs:ml-5 xs:mr-5 max-sm:ml-5 max-sm:mr-5
        ...
        <div className="grid grid-cols-2 ml-10 mr-10 gap-10">
          <div>
